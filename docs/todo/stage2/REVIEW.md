...
| 4 Frontend split | frontend-onboarding-review (restructure stalled 0/13, 59 contract violations, components/ empty, silent excepts regressed 31→44) + stage1 phase3 + `docs/todo/frontend/restructure/`. Owner note: "Frontend needs to be split, large files." |
