...
**Status:** not started
**Depends on:** The developer confirms the checklist rows/strings (QUESTIONS Q1)
...
1. Confirm the checklist rows + strings with the developer (QUESTIONS Q1). Write the tests; watch them fail.
