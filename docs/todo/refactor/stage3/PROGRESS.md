...
| [050 protective halts on by default](050-protective-halts-default-on.md) | YES | **done (2026-09-01)** — demo run: halting, refusing and the reason all PASS after the reason was surfaced (b1a0e3a). Default flips remain owner-side (they cannot reach an existing install) | Simon + Claude | See "Demo 5" below. |
