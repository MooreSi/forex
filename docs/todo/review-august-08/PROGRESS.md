...
| 3 | [010 delete-dead-code](phase3-expansion-tax/010-delete-dead-code.md) | no | blocked (owner decision) | Claude/Darren | detector found 7 unreached/2813 LOC. 3 db.py clones = superseded-dead (test-entangled). 4 others = built-but-UNWIRED features/tools/infra — wire-vs-delete is an owner call. NOTHING deleted. See allowlist + task notes. |
