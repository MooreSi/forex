...
**Layer:** frontend
**Leverage:** the whole point — the pack at [docs/todo/frontend/restructure/](../../frontend/restructure/)
...
1. Owner answers `docs/todo/frontend/restructure/QUESTIONS.md` (4 open; blocks app-shell).
...
- everything under `docs/todo/frontend/restructure/` and the files its tasks name
