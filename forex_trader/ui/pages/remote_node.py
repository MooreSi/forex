...
def _get_sub_engines():
    from forex_trader.breakout_signal import engine as _bo_mod
    from forex_trader.test_signal import engine as _bc_mod
    from forex_trader.gd_copy_signal import engine as _gd_mod
